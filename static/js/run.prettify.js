!function () {
    (function () {
        ...
        })(H[l]); for (var S = H.length, F = [], l = 0, B = P.length; l < B; ++l)F.push("https://raw.githubusercontent.com/google/code-prettify/master/loader/skins/" + encodeURIComponent(P[l]) + ".css"); F.push("/css/prettify.css"); (function (g) {
            function r(l) {
                if (l !== x) {
